...
"""
res： the whole space res[i,j,k...] stand for the length,width,height...
dim:  dimension of space

-------------------------------------
m_V:  need modify when 3D or over
...
class ParticleSystem:
    def __init__(self, res):
        ...
        self.m_V = 0.8 * self.particle_diameter ** self.dim  # for 2D
        # self.m_V = 0.52 * self.particle_diameter ** self.dim  # for 3D
        self.particle_max_num = 2 ** 20
