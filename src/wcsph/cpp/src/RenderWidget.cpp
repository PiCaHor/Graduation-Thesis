...
namespace Fluid3d {
    ...
    void RenderWidget::CreateRenderAssets() {
        ...
        mSlabWhite->Create();
        std::string albedoPath = "./resources/TexturesCom_Marble_SlabWhite_1K_albedo.png";
        std::string roughnessPath = "./resources/TexturesCom_Marble_SlabWhite_1K_roughness.png";
